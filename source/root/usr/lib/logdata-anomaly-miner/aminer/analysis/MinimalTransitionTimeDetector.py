...
class MinimalTransitionTimeDetector(
    ...
    """This class creates events when minimal transition times between states
    (e.g. value combinations of stated paths) are undercut."""
    ...
    def receive_atom(self, log_atom):
        """Receive a log atom from a source and analyzes minimal times between
        transitions."""
    ...
    def print_persistence_event(self, event_type, event_data):
        """Prints the persistence of component_name. Event_data specifies what
    ...
    def remove_from_persistence_event(self, event_type, event_data):
        """Removes the information of event_data from the persistence of
        component_name.
