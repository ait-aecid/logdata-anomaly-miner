...
class EventTypeDetector(AtomHandlerInterface, TimeTriggeredComponentInterface):
    ...
    def __init__(self, aminer_config, anomaly_event_handlers, persistence_id='Default', path_list=None, id_path_list=None,
        ...
        # one or more target_path_list that specify the trace of the sequence detection, i.e., incorrect sequences that are generated by interleaved
        ...
        # List of target_path_list, which variables are being tracked. All other target_path_list will not get tracked. If None all target_path_list are being tracked.
    ...
    def receive_atom(self, log_atom):
        ...
        # Get the current index, eighter from the combination of values of the target_path_list of id_path_list, or the event type
