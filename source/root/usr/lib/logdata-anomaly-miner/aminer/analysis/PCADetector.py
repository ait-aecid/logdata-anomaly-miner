...
class PCADetector(AtomHandlerInterface, TimeTriggeredComponentInterface):
    ...
    def __init__(self, aminer_config, target_path_list, anomaly_event_handlers, window_size, min_anomaly_score, min_variance, num_windows,
        ...
        @param target_path_list parser target_path_list of values to be analyzed. Multiple target_path_list mean that values are analyzed as separate
        dimensions. When no target_path_list are specified, the events given by the full path list are analyzed (one dimension).
        ...
        @param constrain_list list of target_path_list that have to be present in the log atom to be analyzed.
