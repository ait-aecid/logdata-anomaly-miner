...
class EventSequenceDetector(AtomHandlerInterface, TimeTriggeredComponentInterface, EventSourceInterface):
    ...
    def __init__(self, aminer_config, anomaly_event_handlers, id_path_list=None, target_path_list=None, seq_len=3, allow_missing_id=False,
        ...
        @param target_path_list parser target_path_list of values to be analyzed. Multiple target_path_list mean that values are analyzed
               by their combined occurrences. When no target_path_list are specified, the events given by the full path list are analyzed.
        @param anomaly_event_handlers for handling events, e.g., print events to stdout.
        @param id_path_list one or more target_path_list that specify the trace of the sequence detection, i.e., incorrect sequences that
               are generated by interleaved events can be avoided when event sequence identifiers are available.
        ...
        # Thereby, sequence elements may be tuples, i.e., combinations of values, or target_path_list that define events.
