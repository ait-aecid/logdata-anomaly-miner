"""This module contains various methods and class definitions useful for various components from parsing, analysis and event
handling. Larger separate blocks of code should be split into own subfiles or submodules, e.g. persistency."""
...
class LogarithmicBackoffHistory(ObjectHistory):
    ...
    def add_object(self, new_object):
        """Add a new object to the list according to the rules described in the class docstring."""
