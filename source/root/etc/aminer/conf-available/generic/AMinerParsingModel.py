...
def get_model():
  ...
  type_children = []
  type_children.append(FixedDataModelElement('warn-no-openat', \
  ...
  type_children.append(FixedDataModelElement('warn-POSIX-acls', \
          b'WARNING: SECURITY: No checking for backdoor access via \
          POSIX ACLs, use "getfacl" from "acl" package to check manually.'))
  type_children.append(FixedDataModelElement('warn-no-linkat', \
