...
class SimpleByteStreamLineAtomizerFactoryTest(TestBase):
    ...
    def test1get_atomizer(self):
      ...
      new_match_path_detector1 = NewMatchPathDetector(self.aminer_config, [],
        'Default', False)
      
      new_match_path_detector2 = NewMatchPathDetector(self.aminer_config, [],
        'Default', False)
      ...
      self.assertEqual(byte_stream_line_atomizer.default_timestamp_paths, None)
