...
class MatchElementTest(unittest.TestCase):
    ...
    def test2annotate_match(self):
      ...
      self.assertEqual(self.root_element.annotate_match(None), "root: b'root' a1: b'a1' a2: b'a2' a3: b'a3' b1: b'b1' b2: b'b2' b3: b'b3'")
      self.assertEqual(self.root_element.annotate_match(''), "root: b'root'\n  a1: b'a1'\n    a2: b'a2'\n      a3: b'a3'\n  b1: b'b1'\n    b2: b'b2'\n      b3: b'b3'")
    ...
    def test3serialize_object(self):
      ...
      self.assertEqual(self.root_element.serialize_object(), {'path': 'root', 'matchobject': b'root', 'matchString': b'root', 'children': [{'path': 'a1', 'matchobject': b'a1', 'matchString': b'a1', 'children': [{'path': 'a2', 'matchobject': b'a2', 'matchString': b'a2', 'children': [{'path': 'a3', 'matchobject': b'a3', 'matchString': b'a3', 'children': []}]}]}, {'path': 'b1', 'matchobject': b'b1', 'matchString': b'b1', 'children': [{'path': 'b2', 'matchobject': b'b2', 'matchString': b'b2', 'children': [{'path': 'b3', 'matchobject': b'b3', 'matchString': b'b3', 'children': []}]}]}]})
