...
class RuleTest(TestBase):
    ...
    def test1event_generation_match_action(self):
      ...
      t = time()
      event_generation_match_action = EventGenerationMatchAction('Test.%s' % self.__class__.__name__,
        message, [self.stream_printer_event_handler, stream_printer_event_handler2])
    ...
    def test2atom_filter_match_action(self):
      ...
      newMatchPathDetector = NewMatchPathDetector(self.aminer_config, [self.stream_printer_event_handler],
        'Default', False)
    ...
    def test9value_dependent_modulo_time_match_rule(self):
      ...
      match_context = MatchContext(b'14.02.2019 12:00:00')
      match_element = date_time_model_element.get_match_element(self.model_syslog, match_context)
      print(match_element.get_match_object())
