...
class TimeCorrelationDetectorTest(TestBase):
    ...
    def test1_normal_report(self):
        ...
        time_correlation_detector = TimeCorrelationDetector(self.aminer_config, [self.stream_printer_event_handler], 2, 'Default',
                                                            record_count_before_event=10, output_logline=True, use_path_match=True,
                                                            use_value_match=True, min_rule_attributes=1, max_rule_attributes=5)
