...
class TimeCorrelationViolationDetectorTest(TestBase):
    ...
    def test3validate_parameters(self):
        ...
        self.assertRaises(TypeError, TimeCorrelationViolationDetector, self.aminer_config, rules, [self.stream_printer_event_handler], severity=["/tmp/syslog"])
        self.assertRaises(TypeError, TimeCorrelationViolationDetector, self.aminer_config, rules, [self.stream_printer_event_handler], severity="")
        self.assertRaises(TypeError, TimeCorrelationViolationDetector, self.aminer_config, rules, [self.stream_printer_event_handler], severity=b"Default")
        self.assertRaises(TypeError, TimeCorrelationViolationDetector, self.aminer_config, rules, [self.stream_printer_event_handler], severity=True)
        self.assertRaises(TypeError, TimeCorrelationViolationDetector, self.aminer_config, rules, [self.stream_printer_event_handler], severity={"id": "Default"})
        self.assertRaises(TypeError, TimeCorrelationViolationDetector, self.aminer_config, rules, [self.stream_printer_event_handler], severity=())
        self.assertRaises(TypeError, TimeCorrelationViolationDetector, self.aminer_config, rules, [self.stream_printer_event_handler], severity=set())
        self.assertRaises(ValueError, TimeCorrelationViolationDetector, self.aminer_config, rules, [self.stream_printer_event_handler], severity=123)
        self.assertRaises(ValueError, TimeCorrelationViolationDetector, self.aminer_config, rules, [self.stream_printer_event_handler], severity=123.22)
        TimeCorrelationViolationDetector(self.aminer_config, rules, [self.stream_printer_event_handler], severity=None)
        TimeCorrelationViolationDetector(self.aminer_config, rules, [self.stream_printer_event_handler], severity=0)
        TimeCorrelationViolationDetector(self.aminer_config, rules, [self.stream_printer_event_handler], severity=1)
        TimeCorrelationViolationDetector(self.aminer_config, rules, [self.stream_printer_event_handler], severity=0.1)
        TimeCorrelationViolationDetector(self.aminer_config, rules, [self.stream_printer_event_handler], severity=0.99)
