...
class WhitelistViolationDetectorTest(TestBase):
    ...
    def test1match_found(self):
      ...
      t = time.time()
      whitelist_violation_detector = WhitelistViolationDetector(self.aminer_config,
        [path_exists_match_rule, path_exists_match_rule2], [self.stream_printer_event_handler], output_log_line=False)
      ...
      log_atom = LogAtom(match_context.match_data, ParserMatch(match_element),
        t, whitelist_violation_detector)
      ...
      match_context = MatchContext(self.fixed_string)
      match_element = fixed_dme.get_match_element('match', match_context)
      log_atom = LogAtom(match_element.match_object, ParserMatch(match_element),
        t, whitelist_violation_detector)
      ...
      self.assertEqual(self.output_stream.getvalue(), self.__expected_string %
        ...
        whitelist_violation_detector.__class__.__name__, description, 1, "b'fixed String'"))
