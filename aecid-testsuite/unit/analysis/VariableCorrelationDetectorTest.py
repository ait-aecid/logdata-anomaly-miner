...
class VariableCorrelationDetectorTest(TestBase):
    ...
    def test20validate_parameters(self):
        ...
        self.assertRaises(ValueError, VariableCorrelationDetector, self.aminer_config, [self.stream_printer_event_handler], etd, severity=-1)
        self.assertRaises(ValueError, VariableCorrelationDetector, self.aminer_config, [self.stream_printer_event_handler], etd, severity=1.1)
        self.assertRaises(TypeError, VariableCorrelationDetector, self.aminer_config, [self.stream_printer_event_handler], etd, severity=b"Default")
        self.assertRaises(TypeError, VariableCorrelationDetector, self.aminer_config, [self.stream_printer_event_handler], etd, severity="123")
        self.assertRaises(TypeError, VariableCorrelationDetector, self.aminer_config, [self.stream_printer_event_handler], etd, severity={"id": "Default"})
        self.assertRaises(TypeError, VariableCorrelationDetector, self.aminer_config, [self.stream_printer_event_handler], etd, severity=["Default"])
        self.assertRaises(TypeError, VariableCorrelationDetector, self.aminer_config, [self.stream_printer_event_handler], etd, severity=[])
        self.assertRaises(TypeError, VariableCorrelationDetector, self.aminer_config, [self.stream_printer_event_handler], etd, severity=())
        self.assertRaises(TypeError, VariableCorrelationDetector, self.aminer_config, [self.stream_printer_event_handler], etd, severity=set())
        VariableCorrelationDetector(self.aminer_config, [self.stream_printer_event_handler], etd, severity=None)
        VariableCorrelationDetector(self.aminer_config, [self.stream_printer_event_handler], etd, severity=0)
        VariableCorrelationDetector(self.aminer_config, [self.stream_printer_event_handler], etd, severity=0.5)
        VariableCorrelationDetector(self.aminer_config, [self.stream_printer_event_handler], etd, severity=1)
