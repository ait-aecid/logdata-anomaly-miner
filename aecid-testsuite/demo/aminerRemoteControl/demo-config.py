...
def build_analysis_pipeline(analysis_context):
    ...
    prefix = [
        DateTimeModelElement('DTM', b'%Y-%m-%d %H:%M:%S'), DelimitedDataModelElement('source', b'[', consume_delimiter=True),
        DecimalIntegerValueModelElement('log_id'), FixedDataModelElement('brackets', b'] '), FixedWordlistDataModelElement('Severity', [
            b'info', b'error', b'warning', b'debug', b'critical']), FixedDataModelElement('space', b': ')
    ]

    service_children_disk_report = [
        SequenceModelElement('Prefix', prefix),
    ...
    service_children_cron_job = [
        SequenceModelElement('Prefix', prefix), DateTimeModelElement('DTM', date_format_string), FixedDataModelElement('UNameSpace1', b' '),
    ...
    service_children_random_time = [SequenceModelElement('Prefix', prefix), FixedDataModelElement('Space', b'Random: '),
                                    DecimalIntegerValueModelElement('Random')]

    service_children_sensors = [
        SequenceModelElement('Prefix', prefix), SequenceModelElement('CPUTemp', [
    ...
    service_children_cron_job_announcement = [
        SequenceModelElement('Prefix', prefix), DateTimeModelElement('DTM', date_format_string), FixedDataModelElement('Space', b' '),
    ...
    service_children_cron_job_execution = [
        SequenceModelElement('Prefix', prefix), DateTimeModelElement('DTM', date_format_string), FixedDataModelElement('Space1', b' '),
        DelimitedDataModelElement('UName', b' '), FixedDataModelElement('Cron', cron), DecimalIntegerValueModelElement('JobNumber'),
    ...
    new_match_path_value_combo_detector = NewMatchPathValueComboDetector(
        ...
        output_logline=True, learn_mode=False, log_resource_ignore_list=['file:///tmp/other_syslog'])
